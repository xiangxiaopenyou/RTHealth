...
- (void)createContentTableView {
    ...
    if (self.debugEnabled) {
        _contentTableView.layer.borderColor = [UIColor clearColor].CGColor;
        _contentTableView.layer.borderWidth = 1.0;
        _contentTableView.layer.cornerRadius = 10.0;
        
        _contentTableView.tableHeaderView.layer.borderColor = [UIColor clearColor].CGColor;
        _contentTableView.tableFooterView.layer.borderColor = [UIColor clearColor].CGColor;
    }
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if ([contentSubviews count] >0 ) {
        ...
        if (self.debugEnabled) {
            ...
            viewToAdd.layer.borderColor = [UIColor clearColor].CGColor;
        }
